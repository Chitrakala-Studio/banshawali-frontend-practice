...
const FooterButtons = ({ onGenerateFamilyTree,id ,infoPopup,isMobile}) => {
  ...
  return (
    <div className={isMobile? "fixed bottom-0 right-2 w-full flex justify-center ":"fixed bottom-2 right-2 w-full flex justify-center"}>
      <div className={infoPopup ? "w-full max-w-lg flex justify-around items-center px-3 bg-black rounded-lg " : "w-full max-w-lg flex justify-around items-center p-3 "}>
        <button
