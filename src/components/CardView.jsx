...
import { globalData } from "../data/globalData"; // Assuming you have an array of objects like photo_url, name, etc.
import FamilyTreeModal from "./FamilyTreeModal";

const CardView = () => {
  const [selectedFamily, setSelectedFamily] = useState(null);
  const [infoPopup, setInfoPopup] = useState(null); // Manage which card's popup is open
  const [currentIndex, setCurrentIndex] = useState(globalData.length - 1);
  ...
  // Handle swipe and update currentIndex
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        src="https://img.icons8.com/?size=100&id=7703&format=png&color=FFFFFF"
                        alt="cross"
                      />
                    </button>
